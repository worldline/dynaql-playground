...
public class Database {
    ...
    public static Map<Integer, Person> getPeopleSchema(){
        ...
        try(InputStream jsonStream = Thread.currentThread().getContextClassLoader().getResourceAsStream("META-INF/data/person.json")){
            if(jsonStream!=null){
    ...
    public static Map<String,List<Score>> getScoresSchema(){
        ...
        try(InputStream jsonStream = Thread.currentThread().getContextClassLoader().getResourceAsStream("META-INF/data/score.json")){
            if(jsonStream!=null){
